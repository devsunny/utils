...
public class RecordMetaProfiler {
	...
	public final static Pattern NUMBER_PATTERN = Pattern
			.compile(NUMBER_PATTERN_REGEX);
	public final static Pattern DATE_PATTERN = Pattern
			.compile("^(((1|0|2|3)\\d)([/\\-_])((1|0|2|3)\\d)([/\\-_])\\d{4})|(\\d{4}([/\\-_])((1|0|2|3)\\d)([/\\-_])((1|0|2|3)\\d))$");
	public final static Pattern TIME_PATTERN = Pattern
			.compile("^((((1|0|2|3)\\d)([/\\-_.])((1|0|2|3)\\d)([/\\-_.])\\d{4})|(\\d{4}([/\\-_.])((1|0|2|3)\\d)([/\\-_.])((1|0|2|3)\\d)))([\\-_ .])[0-2]\\d(([:\\-_.])[0-5]\\d(([:\\-_.])[0-5]\\d)?)?$");
	...
	protected void updateMetaData(String value, RecordFieldMetaData md) {
		...
		if (md.getTimeCofidence() != -1
				&& md.getType() != RecordFieldMetaData.FIELD_TYPE.STRING
				&& TIME_PATTERN.matcher(str).find()) {
			md.setType(RecordFieldMetaData.FIELD_TYPE.DATETIME);
			md.setTimeCofidence(10);
			md.setDateConfidence(-1);
		} else if (md.getDateConfidence() != -1
				&& md.getType() != RecordFieldMetaData.FIELD_TYPE.STRING
				&& DATE_PATTERN.matcher(str).find()) {
			...
			if ( md.getType() ==null &&  matcher.find()) {
				...
				if (md.getDateConfidence() >= 0
						...
						&& (md.getMaxLength() == 6 || md.getMaxLength() == 8
								|| md.getMaxLength() == 10
								|| md.getMaxLength() == 12 || md.getMaxLength() == 14)) {
	...
	public static void main(String[] args) {
		...
		profiler.updateMetaData(
				"This is a date 12/31/1900 even longer text here", md);
		profiler.updateMetaData("01-01-2014", md);
		System.out.println(md);
